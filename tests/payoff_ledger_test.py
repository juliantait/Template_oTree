...
def main():
    ...
    try:
        ...
        try:
            ...
            # does not scan tests/ — see its _EXCLUDED_DIRS note, which names
    ...
    scanned_files = {os.path.relpath(f, os.path.dirname(_TESTS_DIR))
    ...
    check(not any(f.startswith('tests/') for f in scanned_files),
          "…and tests/ is NOT scanned — this file's own deliberate "
