...
NB this is DETECTION of a stale session existing; scripts/tests/frozen_config_test.py
...
Run:  python scripts/tests/predeploy_frozen_audit_test.py    (oTree must be importable)
